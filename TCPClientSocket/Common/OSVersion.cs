...
namespace MonitorClient3._0.Common
{
...
// Static Fields
		...
		private static readonly OSVersionInfo _WinCE    = new OSVersionInfo( Common.OSPlatformId.WinCE        , true );
				...
				case Common.OSPlatformId.Win32NT:
                    ...
                    case MajorVersionConst.Win7:
                        ...
                        switch (OSMinorVersion)
                        {
                            ...
                            case MinorVersionConst.WinXP: return Common.OSVersion.WinXP;
                            case MinorVersionConst.Win2003: return Common.OSVersion.Win2003;
                            case MinorVersionConst.Win7: return Common.OSVersion.Win7;
