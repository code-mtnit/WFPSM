...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ScalablePictureBox
{
    ...
    internal partial class PictureTracker : UserControl
    {
        ...
        /// current zoom rate
        /// </summary>
        private double currentZoomRate = 0;
        ...
        /// </summary>
        Font zoomRateFont = new System.Drawing.Font("Times New Roman", 8F, ((System.Drawing.FontStyle)((System.Drawing.FontStyle.Regular | System.Drawing.FontStyle.Regular))), System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        public PictureTracker()
        {
            ...
            if (!DesignMode)
            {
                try
                {
                    handCursor = Cursors.Hand;// Util.CreateCursorFromFile("ImageViewerList.Hand.cur");
                    trackerCursor = Cursors.SizeAll;// Util.CreateCursorFromFile("ScalablePictureBox.ImageViewerList.Tracker.cur");
                }
                catch
                { }
            }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
         ...
         //   e.Graphics.FillRectangle(Brushes.LightSteelBlue, ClientRectangle);

            // draw control border
            Rectangle borderRect = this.ClientRectangle;
            borderRect.Width -= 1;
            borderRect.Height -= 1;
            e.Graphics.DrawRectangle(Pens.DarkBlue, borderRect);

            Region rg = new System.Drawing.Region(borderRect);

          //  e.Graphics.DrawLine(Pens.DarkGray, new Point(this.Width - 20, 5), new Point(this.Width - 10, 10)); 
            ...
            try
            {
                ...
                e.Graphics.DrawString(("Zoom : " + (int)(ZoomRate * 100) + "%"), zoomRateFont, Brushes.Black, 3, 3);
            }
            catch
            { }
        }
