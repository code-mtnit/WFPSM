...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ImageBoxFolder
{
  // Cyotek ImageBox
  ...
  /// </summary>
  [DefaultProperty("Image"), ToolboxBitmap(typeof(ImageBox), "Sbn.AdvancedControls.Imaging.ImageViewer.ImageBoxFolder.ImageBox.bmp"), ToolboxItem(true)]
