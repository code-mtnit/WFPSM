...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ListViewFolder
{
    ...
    public class ImageListItem
    {
        ...
        public void OnNeedDrawImage(ImageLisViewItemEventArg e)
        {
            EventHandler<ImageLisViewItemEventArg> handler = NeedDrawImage;
        ...
        public ImageListItem(string filename)
            : this()
        {
            mFileName = filename;
        ...
        public ImageListItem(object key, string text, Size dimensions)
            : this()
        {
            isVirtualItem = true;
            mVirtualItemKey = key;
        ...
        /// <param name="key">The key identifying this item.</param>
        /// <param name="text">Text of this item.</param>
        public ImageListItem(object key, string text)
        ...
        /// </summary>
        /// <param name="key">The key identifying this item.</param>
        public ImageListItem(object key)
