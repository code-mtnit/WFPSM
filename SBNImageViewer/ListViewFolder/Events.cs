...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ListViewFolder
{
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    internal delegate void UpdateVirtualItemDetailsDelegateInternal(ImageListItem item, VirtualItemDetailsEventArgs e);
    /// <summary>
    ...
    public class ImageLisViewItemEventArg : EventArgs
    {
        ImageListItem _Image = new ImageListItem();
        public ImageListItem ImageListViewItem
        {
            get
            {
                return _Image;
        ...
        public ImageLisViewItemEventArg(ImageListItem img)
        {
            ImageListViewItem = img;
        }
    ...
    public class ItemClickEventArgs
    {
        ...
        public ItemClickEventArgs(ImageListItem item, Point location, MouseButtons buttons)
        {
            mItem = item;
            mLocation = location;
            mButtons = buttons;
    ...
    {
        private ImageListItem mPreviousItem;
        private ImageListItem mItem;
        ...
        /// </summary>
        public ImageListItem PreviousItem { get { return mPreviousItem; } }
        /// <summary>
        ...
        public ItemHoverEventArgs(ImageListItem item, ImageListItem previousItem)
        {
            mItem = item;
    ...
    public class ThumbnailCachedEventArgs
    {
        ...
        public ThumbnailCachedEventArgs(ImageListItem item, bool error)
        {
            mItem = item;
            mError = error;
        }
