...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ListViewFolder
{
    ...
    internal class ImageListViewLayoutManager
    {
        ...
        private int TempmFirstPartiallyVisible;
        ...
        public bool UpdateRequired
        {
            get
            {
                ...
                //    return true;
                 if (mImageListView.ViewOffset != cachedViewOffset)
                    return true;
        ...
        public Rectangle GetItemBounds(int itemIndex)
        {
            ...
            if ((mItemAreaBounds.Width - (mCols) * mItemSizeWithMargin.Width) / 2 > 0)
                location.X += (mItemAreaBounds.Width -(mCols) * mItemSizeWithMargin.Width) / 2;
            ...
            //if (itemIndex == 2)
            //    return new Rectangle(location, new Size(300 , 300));
        ...
        public void Update(bool forceUpdate)
        {
            ...
            cachedView = View.Thumbnails;// mImageListView.View;
            cachedViewOffset = mImageListView.ViewOffset;
            cachedSize = mImageListView.ClientSize;
            cachedItemCount = mImageListView.Items.Count;
            cachedItemSize = mImageListView.mRenderer.MeasureItem(View.Thumbnails);
            cachedItemMargin = mImageListView.mRenderer.MeasureItemMargin(View.Thumbnails);
           ...
           // mCols = (int)System.Math.Floor((float)mItemAreaBounds.Width / (float)mItemSizeWithMargin.Width);
            ...
            mImageListView.vScrollBar.Height = mImageListView.ClientRectangle.Height - (mImageListView.hScrollBar.Visible ? mImageListView.hScrollBar.Height : 0);
             ...
             TempmFirstPartiallyVisible  = mFirstPartiallyVisible;
            {
            ...
            if (TempmFirstPartiallyVisible != mFirstPartiallyVisible)
            {
                try
                {
                    mImageListView.OnViewItemChanged(null, mImageListView.Items[mFirstPartiallyVisible]);
                }
                catch 
                {
