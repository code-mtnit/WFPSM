...
namespace Sbn.AdvancedControls.Imaging.ImageViewer.ListViewFolder
{
    public partial class ImageListView
    {
        ...
        internal class ImageListViewNavigationManager : IDisposable
        {
            ...
            private Dictionary<ImageListItem, bool> highlightedItems;
            ...
            /// </summary>
            public ImageListItem HoveredItem { get; private set; }
            /// <summary>
            ...
            /// </summary>
            public ImageListItem DropTarget { get; private set; }
            /// <summary>
            ...
            /// </summary>
            public ItemHighlightState HighlightState(ImageListItem item)
            {
            ...
            {
                ImageListItem oldHoveredItem = HoveredItem;
            ...
            public void MouseUp(MouseEventArgs e)
            {
                ...
                else if (MouseSelecting)
                {
                    ...
                    {
                        foreach (KeyValuePair<ImageListItem, bool> pair in highlightedItems)
            ...
            {
                if (HoveredItem != null  || HoveredPaneBorder != false)
                {
                    if (HoveredItem != null)
            ...
            public void DragDrop(DragEventArgs e)
            {
                ...
                {
                    // Reorder items
                    List<ImageListItem> draggedItems = new List<ImageListItem>();
                    int i = -1;
                    ...
                    if (DropToRight) i++;
                    foreach (ImageListItem item in draggedItems)
                    {
            ...
            public void DragOver(DragEventArgs e)
            {
                if (mImageListView.AllowDrop || (mImageListView.AllowDrag && selfDragging))
                {
                    ...
                    else
                    {
                        ...
                        ImageListItem dragDropTarget = mImageListView.Items[index];
