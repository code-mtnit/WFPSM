...
namespace Sbn.AdvancedControls.Imaging.ThumbnailControl
{
    ...
    public partial class ImageListView : Control
    {
        ...
        public ImageListView()
        {
            ...
            ResourceManager manager = new ResourceManager("Sbn.AdvancedControls.Imaging.ThumbnailControl.ImageListViewResources",
        ...
        {
            //Move To Dispose Method by rm 20121224
            cacheManager.Stop();
        ...
        protected virtual void OnMovedItems(MovedItemsEventArgs e)
        {
            if (MovedItems != null)
                MovedItems(this, e);
        ...
        /// </summary>
        [Category("Drag Drop"), Browsable(true), Description("Occurs after the user moved items on to the control.")]
        public event MovedItemsEventHandler MovedItems;
        /// <summary>
        /// Occurs after the user drops files on to the control.
        /// </summary>
