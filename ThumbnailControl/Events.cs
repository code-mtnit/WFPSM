...
namespace Sbn.AdvancedControls.Imaging.ThumbnailControl
{
    ...
    public delegate void MovedItemsEventHandler(object sender, MovedItemsEventArgs e);
    /// <summary>
    /// Represents the method that will handle the DropFiles event. 
    /// </summary>
    /// <param name="sender">The ImageListView object that is the source of the event.</param>
    ...
    public class MovedItemsEventArgs
    {
        private bool mCancel;
        private int mIndex;
        private string[] mFileNames;
        private bool mdropToRight = false;
        private bool mdropToAfterEndItem = false;

        public bool MdropToAfterEndItem
        {
            get { return mdropToAfterEndItem; }
            set { mdropToAfterEndItem = value; }
        }

        public bool DropToRight
        {
            get { return mdropToRight; }
            set { mdropToRight = value; }
        }
        ...
        /// </summary>
        public List<ImageListViewItem> Items { get { return mItems; } }
        ...
        public MovedItemsEventArgs(int index, List<ImageListViewItem> items)
        {
            mCancel = false;
            mIndex = index;
            mItems = items;
        ...
        public MovedItemsEventArgs(int index, List<ImageListViewItem> items , bool IsMoveToRight , bool IsMoveToAfterEndItem)
        {
            mCancel = false;
            mIndex = index;
            mItems = items;
            mdropToRight = IsMoveToRight;
            mdropToAfterEndItem = IsMoveToAfterEndItem;
        }
    }
