...
namespace Sbn.FramWork.Windows.Forms.OtherForms
{
    ...
    public class SBNFormController : NativeWindow
    {
            ...
            set
            {
               // _currentForm = value;
                ...
                if (_currentForm != null)
                    _currentForm.HandleCreated -= new EventHandler(ParentFormHandleCreated);
                ...
                if (_currentForm.IsHandleCreated)
                {
                    InitializeMdiClient();
                    //RefreshProperties();
                }
        ...
        private void ParentFormHandleCreated(object sender, EventArgs e)
        {
            ...
            CurrentForm.HandleCreated -= new EventHandler(ParentFormHandleCreated);
            InitializeMdiClient();
          //  RefreshProperties();
        }
        ...
        private HIT_CONSTANTS HitTest()
        {
            ...
            GetWindowRect(this.CurrentForm.Handle, ref windowRect);
        ...
        private void FrameChanged()
        {
            ...
            GetWindowRect(this.CurrentForm.Handle, ref rcClient);
            // force a calc size message
            SetWindowPos(this.CurrentForm.Handle,
                         IntPtr.Zero,
        ...
        {
            RedrawWindow(this.CurrentForm.Handle, IntPtr.Zero, IntPtr.Zero, RDW_FRAME | RDW_UPDATENOW | RDW_INVALIDATE | RDW_ERASE);
        }

        private void PaintThis(IntPtr hdc, RECT rc)
        {
            RECT clientRect = new RECT();
            GetClientRect(this.CurrentForm.Handle, ref clientRect);
            ...
            if (!_bPaintWindow)
            {
                ...
                clr = ColorTranslator.ToWin32(this.CurrentForm.BackColor);
                hb = CreateSolidBrush(clr);
                FillRect(hdc, ref clientRect, hb);
                DeleteObject(hb);
            }
            ...
            if (_bExtendIntoFrame && _bDrawCaption)
            {
                ...
                using (Graphics g = Graphics.FromHdc(hdc))
                {
                    ...
                    {
                        SizeF sz = g.MeasureString(this.CurrentForm.Text, fc);
                        ...
                        using (StringFormat sf = new StringFormat())
                        {
                            ...
                            using (GraphicsPath path = new GraphicsPath())
                            {
                                ...
                                path.AddString(this.CurrentForm.Text, fc.FontFamily, (int)fc.Style, fc.Size, captionBounds, sf);
                ...
                case WM_SYSCOMMAND:
                    {
                        ...
                        {
                            this.CurrentForm.Height = _iStoreHeight;
                        }
                        else if (this.CurrentForm.WindowState == FormWindowState.Normal)
                        {
                            _iStoreHeight = this.CurrentForm.Height;
                        }
                        base.WndProc(ref m);
                        break;
                    }
                ...
                case WM_ACTIVATE:
                    {
                        ...
                        DwmExtendFrameIntoClientArea(this.CurrentForm.Handle, ref _tMargins);
                        m.Result = MSG_HANDLED;
                        base.WndProc(ref m);
                        break;
                    }
