...
namespace Sbn.AdvancedControls.Imaging.SbnPaint
{
    ...
    public class Resize : Select
    {
        ...
        public override void MouseUp(IDocument document, MouseEventArgs e)
        {
            ...
            object objTempTag = null;
            try
            {
                objTempTag = ((Sbn.AdvancedControls.Imaging.SbnPaint.Image)Select.LastSelectedShape).Tag;
            }
            catch
            {
            ...
            if (Select.LastSelectedShape == null)
                return;
           Sbn.FramWork.Drawing.Appearance app = Select.LastSelectedShape.Appearance;

          

            document.Shapes.Remove(Select.LastSelectedShape);
            Select.LastSelectedShape = Ghost.Shape.Clone() as IShape;
            Select.LastSelectedShape.Appearance = app;
            try
            {
                ...
                try
                {
                    ...
                    Select.LastSelectedShape.OnEditedImage();

                  
                    // Select.LastSelectedShape.Appearance.Image.Save("C:\\ooo.jpg");
                }
                catch
                {
               ...
               // Select.LastSelectedShape.Appearance.Image.Save("C:\\frfr.jpg");
                ((Shape)Select.LastSelectedShape).Tag = objTempTag;
            }
            catch
            { }
