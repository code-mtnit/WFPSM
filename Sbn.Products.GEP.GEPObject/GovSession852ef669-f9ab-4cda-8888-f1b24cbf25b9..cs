namespace Sbn.Products.GEP.GEPObject
{
    ...
    public class GovSession : SbnObject
    {
        ...
        private GovSessionMessagings _Messages;
        ...
        private Sbn.Products.GEP.GEPObject.GovPresentations _GovPresents;
        ...
        private string _GovReasonTitle = null;
        ...
        public static string at_MessagesFirstLevelAttributes
        {
            get
            {
                return "GovSession.MessagesFirstLevelAttributes";
            }
        }

        public static string at_MessagesID
        {
            get
            {
                return "GovSession.MessagesID";
            }
        }
        ...
        public static string at_GovPresentsFirstLevelAttributes
        {
            get
            {
                return "GovSession.GovPresentsFirstLevelAttributes";
            }
        }
        ...
        public static string at_GovPresentsID
        {
            get
            {
                return "GovSession.GovPresentsID";
            }
        }
        ...
        [Description("پیامها"), DisplayName("پیامها"), Category("پیامها"), DocumentAttributeID("27991"), Browsable(true), IsRelational("False"), AttributeType("GovSessionMessagings"), IsMiddleTableExist("False"), RelationTable("")]
        public GovSessionMessagings Messages
        {
            get
            {
        ...
        [Description(""), AttributeType("GovPresentations"), IsMiddleTableExist("False"), RelationTable("GovSession_Presentation_M"), DisplayName(""), Category(""), DocumentAttributeID("9316"), Browsable(true), IsRelational("True")]
        public Sbn.Products.GEP.GEPObject.GovPresentations GovPresents
        {
            get
            {
        ...
        public string GovReasonTitle
        {
            get
            {
                return _GovReasonTitle;
            }

            set
            {
                _GovReasonTitle = value;
            }
        }
    }
}
